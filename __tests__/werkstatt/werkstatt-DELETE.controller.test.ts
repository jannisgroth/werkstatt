...
describe('DELETE /rest/werkstaette', () => {
    ...
    test('Vorhandene Werkstatt loeschen', async () => {
        // given
        const url = `/rest/${id}`;
    ...
    test('Werkstatt loeschen, aber mit falschem Token', async () => {
        // given
        const url = `/rest/${id}`;
        const token = 'FALSCH';
        const headers: Record<string, string> = {
    ...
    test('Vorhandene Werkstatt als "user" loeschen', async () => {
        // given
        const url = `/rest/50`;
