...
import { type GraphQLQuery } from '../werkstatt/werkstatt-mutation.resolver.test.js';
import { type GraphQLResponseBody } from '../werkstatt/werkstatt-query.resolver.test.js';
